...
8. 走一遍首次上手：**先跑前提传达门**——同一名干净上下文子代理、同一批常速冷启动第一分钟
   的画面，四问一并作答（我是什么 / 我要什么 / 什么会终结这一局 / 我主要在反复做什么），
   逐字落盘 `qa/evidence/premise-gate.md`；未跑或记 `NOT_RUN` 时首次上手不得判 `PASS`。
   再实测首个有意义动作与冷启动节拍；两分钟理解度（"我是谁/
