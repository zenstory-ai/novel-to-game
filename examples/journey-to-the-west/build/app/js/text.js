...
export const TEXT = {
  ...
  topbar: {
    ...
    system: '系统', systemTip: '存档 / 读档 / 音效 / 帮助',
  },
  ...
  panels: {
    ...
    recommend: '推荐加点',
    recommendSkill: '推荐修炼',
    growthNote: '每场胜利 +5 潜力点、+1 修炼点;修炼点投给已习得法术:威力+6%/级、耗蓝-2,至多三重。',
    treasureSwap: '更换法宝',
    treasureSwapTip: '战斗之外换持法宝,不耗分文',
  ...
  battle: {
    ...
    autoTip: '让伙伴自行判断这一回合;不会替你破解关键战场规则(BOSS 战只普攻)',
    repeatTip: '沿用这个伙伴上一回合的招式与目标',
    // attackTip/skillTip/fleeTip 已删(简报 T10):词条释义不是反馈,收进「助」帮助面板;
    // BOSS 战不可逃跑由按钮变灰表达。防御这条报数值后果,属反馈,保留。
    defendTip: '本回合受伤减半,回复 10% 法力',
    itemTip: '使用丹药与芭蕉扇',
    dingfeng: '定风丹护体!',
  },
  ...
  tutorial: {
    title: '第一次战斗 · 怎么打',
    lines: [
      '先为每位伙伴下令;全员选完后,双方按上方顺序依次行动。下一回合可点【沿用】少走重复步骤。',
      '五行:金→木→土→水→火→金。选中目标时会显示克制;真正要判断的是打谁、何时换形。',
      '防御会减半本回合受伤并回复法力。悟空的【特技】能改五行;罗刹女体弱时另有智取之法。',
    ],
    ok: '开战!',
  ...
  help: {
    ...
    body: [
      ...
      '【令】攻击不耗法力;法术耗法力,分单体/群体/增益减益;道具是丹药与芭蕉扇;逃跑可脱离战斗(BOSS 战无效)。',
    ],
  },
  ...
  onceCards: {
    ...
    fakefan: {
      title: '假扇与捕妖绳',
      lines: [
        '这柄「芭蕉扇·伪」来路可疑。若执意用它,火势会亲自给出答案。',
        '火兵血气≤40%时,可用「捕妖绳」收服为召唤兽,日后上阵助战。',
        '火口会灼伤非水系;悟空可变玄甲龟将,也可依靠先前选中的避火锦。',
      ],
    },
    truefan: {
      title: '真扇三段',
      lines: [
        '真扇依次只有三段:息火清敌方增益,生风提全队速度,落雨带来恢复与破绽。',
        '牛魔王的蓄力会提前一回合明示;谁来承受、要不要换阵,由你决定。',
        '白牛真身每回合会累积【狂暴】;息火能清去已有狂暴,但三段次序一旦推进便不能回头。',
      ],
    },
  },
  ...
  story: {
    ...
    luoshaPre1: [
      ...
      { who: 'luosha', text: '成正果?南海紫竹林是好。可做娘的三年不见孩儿一面,这声「善财童子」,是拿我母子离散换的!你说,我该不该恨?' },
      { who: 'wukong', text: '……嫂嫂的苦,俺老孙懂。可火焰山拦的是取经路,山下烤的是百姓的庄稼。借扇三日,熄火即还,俺以性命作保。' },
      { who: 'luosha', text: '性命?你的性命值几两?要借扇——先问过我手中双剑,再问过我洞中姐妹!' },
    ...
    lingji: [
      ...
      { who: 'lingji', text: '我这有两件灵宝,都对眼前的症候:定风丹吞下,百风不侵,纵是芭蕉扇也休想动你分毫;避火锦披上,烈焰难伤,火里来去如踏平地。' },
      { who: 'lingji', text: '只是缘法有限,两件只带得一件。先挡她的扇风,还是备着前路的八百里火焰山——大圣自择。' },
      { who: 'wukong', text: '容俺老孙思量思量!' },
    ],
    luoshaPre2: [
    ...
    luoshaPre2b: [ // 授宝选了避火锦的再战开场(无定风丹,硬挺扇风)
      { who: 'luosha', text: '泼猴!吃了我一扇,居然还敢回来?' },
      { who: 'wukong', text: '嫂嫂,俺老孙又回来了!你那扇子,今日只管扇!' },
      { who: null, text: '罗刹女连挥数扇,阴风怒号——悟空一个筋斗跌出老远,翻身又起,裹紧避火锦,竟又站回洞前!' },
      { who: 'luosha', text: '好个难缠的猴子!……姐妹们,结阵再战!' },
    ],
    luoshaMid: [ // 化虫入腹演出
    ...
    postBattle1: [
      ...
      { who: null, text: '罗刹女侧身递出芭蕉扇,指尖在扇柄上顿了一顿,终是松了手。' },
      { who: 'luosha', text: '(低声)去吧。只盼它……「灵验」。' },
    ...
    treasureIntro: [
      { who: 'tudi', text: '且慢!火炎校尉遗下一角炉砖残图。图上金木水火土五脉交错,像是当年八卦炉砖坠地时压住的一处旧藏。' },
      { who: 'wukong', text: '来得正好。前头要会那老牛,先从他这火脉里借几样趁手物件!' },
      { who: 'sha', text: '图只指地脉,不指吉凶。得了东西须知收手,莫叫妖气合围。' },
    ],
    treasureReturn: {
      safe: { who: 'bajie', text: '够了够了!背囊已有分量,再掘下去若惊动妖穴,岂不白忙?猴哥,咱见好就收。' },
      deep: { who: 'wukong', text: '外藏护住,深层也探了个明白。妖气还没合围——正是收棒走人的时候!' },
      forced: { who: 'sha', text: '妖气已满!我护住外层行囊,深处这些且舍下。人齐物在,便不是空手而归。' },
    },
    preYumian: [
    ...
    pianzhen: [
      ...
      { who: 'luosha', text: '那猴子说,红孩儿在南海做了善财童子……大王,你说,孩儿他一个人,夜里哭不哭?' },
      { who: 'wukong', text: '(心口一酸)……童子有好日子,夫人放心。' },
      { who: 'luosha', text: '……奇怪,大王今日,怎么满身水汽?' },
      { who: 'wukong', text: '碧波潭老龙留我吃了几杯水酒。夫人,真扇既在,俺自去熄了火焰山!' },
      { who: null, text: '罗刹女不疑有他,取出真扇相付。悟空接扇在手,只觉那扇子沉得出奇——骗是骗成了,心里却像欠了她一回。' },
    ],
    fanpian1: [
    ...
    treasureChoice: {
      title: '灵吉菩萨授宝 · 只带一件',
      options: [
        { key: 'dingfengdan', fore: '罗刹女的扇风能把人吹出千里,洞中妖丝也专缠人脚步。此丹定住风行:全队速度+6,此后任他神风妖丝,再不能拖慢半分。' },
        { key: 'bihuojin', fore: '前路是八百里火焰山——火兵的火弹、校尉的烈焰,乃至牛魔王一身火功,都要烧到身上。此锦护住全队:火系伤害减去四分之一。' },
      ],
    },
    ...
    equipChoice: {
      title: '摩云洞缴获 · 悟空拾一件',
      options: [
        { key: 'ruyibang_jing', fore: '下一战便是那老牛。棒沉一分是一分:攻击+12、暴击+5%,抢先把他的混铁棍打回去。' },
        { key: 'suozijia', fore: '下一战便是那老牛。他蓄力一棍能去六成血,披了这甲:防御+12、体力+40,挨得住才还得出手。' },
        { key: 'fengchiguan', fore: '下一战便是那老牛。脚快手快:速度+8、暴击+3%,抢在他出棍之先落棒。' },
      ],
    },
    fanpianCheck: [
    ...
    godAssistDialog: [
      ...
      { who: 'luosha', text: '大王!妾身来了——红孩儿已有正果,你我夫妻,还要背这满身孽债做什么?' },
      { who: 'luosha', text: '扇子,我情愿借出。大王,降了吧,回家去。' },
      { who: 'niumowang', text: '……连夫人也……罢,罢,罢!五百年结拜今日了断,这「平天大圣」,不做也罢!' },
    ],
    // 三借章节卡(简报三.1):一借·被骗 / 二借·假扇 / 三借·真扇,演出与条件各自不同
    chapters: {
      c1: { seal: '一', title: '第一借 · 好言相借', sub: '红孩儿的债,先撞在悟空身上' },
      c2: { seal: '二', title: '第二借 · 化虫入腹', sub: '到手的扇子,未必是真扇' },
      c3: { seal: '三', title: '第三借 · 智取真扇', sub: '你骗得,他也骗得' },
    },
    phase2: [
      { who: null, text: '牛魔王现出白牛真身!头如峻岭,角似铁塔;每拖一回合,【狂暴】便再深一层。' },
    ],
    ending: [
  ...
  overworld: {
    title: '序幕 · 火焰山脚',
    tip: '你是孙悟空,带唐僧师徒过火焰山。点击地面行走;点击土地问话;去东北方找罗刹女借扇。',
    battle: '前往翠云山芭蕉洞',
  },
};
