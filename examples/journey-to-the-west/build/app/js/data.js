...
export const SKILLS = {
  ...
  huanhuo: { name: '唤火助威', kind: 'mag', mul: 0, mp: 0, target: 'self', summon: { key: 'firemob1', count: 1, maxSummons: 2 }, cooldown: 3, desc: '召唤一波火兵' },
...
export const ENEMIES = {
  ...
  firemob1: {
    ...
    base: { hp: 430, mp: 0, atk: 76, def: 32, spd: 66, mag: 70 },
  ...
  firemob2: {
    ...
    base: { hp: 640, mp: 0, atk: 90, def: 40, spd: 58, mag: 82 },
