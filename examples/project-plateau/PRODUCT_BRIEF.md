...
On 2026-07-31, the first input-only Strong path crossed the complete connected route without teleport or direct time advancement in `55.2` wall-clock seconds, travelled `128.348` world units and returned with `336.7` of the original `420` seconds. That falsified the earlier 5–8 minute / 330–390-second consumption assumption: the existing decision space was being padded on paper, not in play. The product boundary was therefore reconciled to a 1–3 minute run and a 180-second light budget instead of adding empty traversal or artificial waits. D15 must preserve the measured Strong/Mixed/Panic outcomes under this revision and first-time testers must still answer the premise/genre questions before any later expansion.
