...
export const CANOPY_TREE_LEAF_RETENTION_PROFILE = Object.freeze({
  version: 'age-wind-and-habitat-leaf-retention-v2',
  sourceModel: 'succession-age-wind-damage-slope-wetness-and-stable-individual-rank',
  minimumRetention: 0.68,
  maximumRetention: 0.955,
  windDamageLoss: 0.12,
  maximumSlopeLoss: 0.025,
  maximumDrynessLoss: 0.025,
  maximumIndividualLoss: 0.018,
