...
自动化结论只说明当前 3 人／6 回合切片可启动、可完成、可拒绝、可重开，设计要求的关系
闭环与关键画面可观察。是否值得继续玩只能由目标成年玩家试玩回答。
...
| 每名女主路线、拒绝和理解型结果可达 | 通过 | 月娘／金莲／瓶儿完整路径断言 |
| 三名女主亲密后各有主动次晨回响 | 通过 | `yue_help`、`pan_claim`、`pinger_help` 浏览器路径 |
| `到此为止` 始终可选 | 通过 | 每次夜间节点浏览器断言 |
...
年龄确认后第一屏同时给出“你是西门庆”“今晚进谁的门，明早就接谁的账”，进入后无需词典
即可在正堂三选一。首个选择立即改变人物账并写进公开历史。自动化能证明路径与反馈存在；
未以此替代新人实际理解度访谈。

### 核心幻想演出：`PASS`

三位成年女主在标题与路线近景中直接看向玩家；玩家选择一人后，从白天筹码进入人物回应、
亲密节点，再在次晨接住其他人的嫉妒或索取。第五天三人同场公开追问玩家。卖点不是只剩
`qing/yu/du` 数字，已有角色近景、路线 CG、群体冲突、声音与后果场面。

### 招牌帧符合：`PASS`

视觉裁决第 5 轮为 97/100。标题、人物近景、次晨、中秋宴、场景册重看与结算共享晚明册页／
工笔套印语言；
