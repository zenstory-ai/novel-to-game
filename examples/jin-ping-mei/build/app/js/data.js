...
export const ENDINGS = Object.freeze({
  ...
  intrigue: {
    title: '人情能办事',
    tag: '拿风月去开门',
    // 曝光决定权谋结局的成色:干净办成、被人看着办成、还是整条街都记住了你的价码。
    texts: {
      clean: '催账人走了，名帖收进了袖里。这一局，外头还不知道是你办的。',
      watched: '催账人走了，桌上还摊着几张不该见光的名帖。院里有人笑，有人已经叫丫鬟去上锁。',
      burned: '催账人走了。可这条街上的人如今都知道西门大官人肯拿什么换事情办成——下一个来敲门的，开价会比今天高。',
    },
  },
  unstable: {
    title: '门一扇扇关',
    tag: '这六日没过明白',
    // F4:按输在哪一条收尾,不再所有失败共用一句。
    texts: {
      no_scene: '{name}的灯亮到三更。你在廊下站了一会儿，到底没推那扇门。',
      second_too_close: '两处院门都替你留着灯。留灯的人各自记着，你哪一夜是从另一边过来的。',
      broke_word: '席上你许过的那句话，如今谁都记得，只有你自己没兑。三处门闩今夜落得比往常早。',
      not_enough_power: '秘密递出去了，事没办成。门外那几个人明日还来。',
      spread_thin: '六日里你哪一处都坐过，哪一处都没坐到最后。更漏将尽，廊下只剩你的脚步。',
    },
  },
});
